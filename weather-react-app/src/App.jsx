...
function App() {
  ...
  const [weatherbkgrnd, setweatherbkgrnd] = useState("Clouds");
  ...
  console.log(weekmaxData, weekminData);
  return (
    <div className="App">
              ...
              <div>
                ...
                <div>
                  <p>
                    ...
                    {Math.round(cityData.wind.speed)}
                    <br />
                    <strong>AQI:</strong> <span id="air-quality">GOOD</span>
                  </p>
                </div>
              </div>
            </div>
